export const projectData = [
  ...
  },
  {
    id: "algos",
    title: "Algo Patterns",
    url: "https://algo-patterns-tau.vercel.app/",
    descArr: [
      "The Software Engineer's study buddy for learning algorithm patterns on the go",
      "Mobile first design",
      "Quiz interface with clear progression",
    ],
    description:
  ...
  },
  {
    id: "phasmo",
    title: "Phasmo Buddy",
    url: "https://phasmo-buddy.vercel.app/",
    descArr: [
      "A web app that helps players of the game Phasmophobia track their evidence and ghost hunting progress",
      "Built with React",
      "Complex logical state management",
      "Responsive design",
    ],
    description:
      "Phasmo Buddy is a web app that helps players of the game Phasmophobia track their evidence and ghost hunting progress. The app is built using React, Redux, and TypeScript. The app is integrated with Firebase for user authentication and data storage. I have also worked on the backend using Node.js and Express.js. The app is deployed on Vercel.",
  ...
  {
    id: "businessCard",
    title: "Custom Events Business Card",
    url: "https://drive.google.com/file/d/1KFnZvMy7lL0sEDBYHQem_ZoAgjYwuSMw/view?usp=sharing",
    descArr: [
      "Custom business card design for a hospitality and events professional",
      "3D modelled with Blender",
      "Custom logo design",
    ],
    description:
      "Phasmo Buddy is a web app that helps players of the game Phasmophobia track their evidence and ghost hunting progress. The app is built using React, Redux, and TypeScript. The app is integrated with Firebase for user authentication and data storage. I have also worked on the backend using Node.js and Express.js. The app is deployed on Vercel.",
